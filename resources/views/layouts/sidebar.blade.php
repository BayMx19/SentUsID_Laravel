        ...
        <div class="menu-inner">
            <nav>
                ...
                <ul class="metismenu" id="menu">
                    <li class="active">
                        <a href="" aria-expanded="true"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" fill="currentColor" class="bi bi-columns" viewBox="0 0 16 16">
                                <path
                    ...
                    <li class="">
                        <a href="" aria-expanded="true"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                            ...
                            </svg><span>List Mitra</span></a>
                    </li>
                    <li class="">
                        <a href="" aria-expanded="true"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" fill="currentColor" class="bi bi-clipboard2-data" viewBox="0 0 16 16">
                                <path
                    ...
                    <li class="">
                        <a href="" aria-expanded="true"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                            ...
                            </svg><span>List Produk</span></a>
                    </li>
                    <li class="">
                        <a href="" aria-expanded="true"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" fill="currentColor" class="bi bi-qr-code-scan" viewBox="0 0 16 16">
                                <path
                            ...
                            </svg><span>Scan</span></a>
                    </li>
                    <li class="">
                        <a href="" aria-expanded="true"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" fill="currentColor" class="bi bi-shop" viewBox="0 0 16 16">
                                <path
                    ...
                    <li class="">
                        <a href="" aria-expanded="true"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <!-- <ul class="metismenu" id="menu">
                 <li :class="(this.$route.path === '/home') ? 'active' : ''">
                     <router-link to="/home" aria-expanded="true"><i
                             class="ti-dashboard"></i><span>dashboard</span></router-link>
