                    ...
                    <div class="card">
                        <div class="card-body">
                            <h1 class="header-title">
                                ...
                                <a href="{{ '/akun' }}"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                            ...
                            <form action="/info-akun/update/{{ request()->route('id') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="search" name="email" value="{{ Auth::user()->email }}"
                                ...
                                @if (Auth::user()->user_role !== 'SuperAdmin')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="notelp" value="{{ Auth::user()->notelp }}"
                                            id="example-text-input">
                                    </div>
                                    <div class="mb-3">
