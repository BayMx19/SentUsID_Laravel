                    ...
                    <div class="card">
                        <div class="card-body">
                            <h1 class="header-title">List Mitra</h4>
                                <div class="">
                                    <a href="{{ '/add-mitra' }}"><button class="button-tambah" style="float:right;">Tambah
                                            Mitra</button></a> <br>
                                </div>
                                <div class="data-tables datatable-primary table-responsive mt-3">
                                    ...
                                    <table class="table datatable-primary text-center myDatamitra display" id="myDatamitra">
